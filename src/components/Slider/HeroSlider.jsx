...
export default function HeroSlider({ data }) {
  ...
  return (
    <>
      ...
      {/* <div className="cs_slider_navigation d-flex cs_row_gap_15 flex-column position-absolute cs_zindex_4">
        <div
          className="cs_slider_btn filter cs_height_45 cs_width_45 bg-white rounded-circle d-flex align-items-center justify-content-center bg-accent-hover cs_transition_4"
          onClick={previous}
        >
          <svg
            width={20}
